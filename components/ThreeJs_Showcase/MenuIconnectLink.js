...
<div>
	<a className="Icon">
 		<Link href="/menu" >
		<div className="MenuIcon" onMouseLeave={scaleBack} onMouseOver={scaleUp}><div className="ObenBalken"/> <div className="UntenBalken"/></div>
 		</Link>
	</a>
	<style jsx>
	{`
